...
\begin{resume}
  ...
  %__________________________________________________________________________________________________________________
    ...
    \textbf{Robus}\hfill \textbf{May 2014 -- August 2014} \vspace{1mm}\\\vspace{0mm}%
    ...
    \begin{list3}
        ...
        \item This generator was used widely during the fair cache allocation experiments and eventually contributed to a submission of paper to SIGMOD 2015.
    \end{list3}
